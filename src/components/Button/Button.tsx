...
/**
 * A Generic Button component. Pass it some text or children if needed.
 * Passing some text as children is the minimum requirement.
 * @param {keyof typeof sizeClassnames} size
 * @param {keyof typeof colorClassnames} scolor
 * @returns
 */
export const Button: React.FC<ButtonProps> = ({
  ...
  return (
    ...
    >
      ...
      {loading ? (
        <span className={`absolute`}>S{/* <Spinner size={size === "small" ? "2" : "4"} /> */}</span>
      ) : null}
    </button>
  );
};
